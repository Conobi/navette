...
comptime GUARD_TAG_NEW_TOKEN_SERVER = "[QUIC-NEW-TOKEN-SERVER]"
comptime GUARD_TAG_HANDSHAKE_DONE_SERVER = "[QUIC-HANDSHAKE-DONE-SERVER]"
comptime GUARD_TAG_MAX_STREAM_DATA_NONEXIST = "[QUIC-MAX-STREAM-DATA-NONEXIST]"
comptime GUARD_TAG_MAX_STREAM_DATA_RECV_ONLY = "[QUIC-MAX-STREAM-DATA-RECV-ONLY]"
comptime GUARD_TAG_MAX_STREAMS_OVERFLOW = "[QUIC-MAX-STREAMS-OVERFLOW]"
comptime GUARD_TAG_STREAMS_BLOCKED_OVERFLOW = "[QUIC-STREAMS-BLOCKED-OVERFLOW]"
comptime GUARD_TAG_CID_RETIRE_PRIOR_GT_SEQ = "[QUIC-CID-RETIRE-PRIOR-GT-SEQ]"
comptime GUARD_TAG_CID_ZERO_LENGTH = "[QUIC-CID-ZERO-LENGTH]"
comptime GUARD_TAG_STREAM_LARGE_OFFSET = "[QUIC-STREAM-LARGE-OFFSET]"
