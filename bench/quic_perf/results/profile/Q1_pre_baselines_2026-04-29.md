...
- `bench/build.sh` worktree-relative `BOUCLE_DIR` path failure recurs as expected — fixed by passing explicit env vars (`BOUCLE_DIR=/home/donokami/Projets/perso/boucle SIMDJSON_DIR=/home/donokami/Projets/perso/json-simd-mojo`) per `feedback_bench_offbuild_image_hygiene.md`.
