# AUTO-GENERATED by scripts/gen_rlsm_bindings.py - DO NOT EDIT BY HAND.
...
comptime rlsm_gzip_init_fn = fn() -> UnsafePointer[NoneType, MutAnyOrigin]
comptime rlsm_gzip_feed_fn = fn(UnsafePointer[NoneType, MutAnyOrigin], UnsafePointer[UInt8, MutAnyOrigin], Int, UnsafePointer[UInt8, MutAnyOrigin], Int) -> Int64
comptime rlsm_gzip_finish_fn = fn(UnsafePointer[NoneType, MutAnyOrigin], UnsafePointer[UInt8, MutAnyOrigin], Int) -> Int64
comptime rlsm_gzip_free_fn = fn(UnsafePointer[NoneType, MutAnyOrigin]) -> None
comptime rlsm_br_init_fn = fn() -> UnsafePointer[NoneType, MutAnyOrigin]
comptime rlsm_br_feed_fn = fn(UnsafePointer[NoneType, MutAnyOrigin], UnsafePointer[UInt8, MutAnyOrigin], Int, UnsafePointer[UInt8, MutAnyOrigin], Int) -> Int64
comptime rlsm_br_finish_fn = fn(UnsafePointer[NoneType, MutAnyOrigin], UnsafePointer[UInt8, MutAnyOrigin], Int) -> Int64
comptime rlsm_br_free_fn = fn(UnsafePointer[NoneType, MutAnyOrigin]) -> None
...
# Allocate a GzipState. Returns an opaque pointer; free with rlsm_gzip_free.
fn load_rlsm_gzip_init(ref handle: OwnedDLHandle) -> rlsm_gzip_init_fn:
    return handle.get_function[rlsm_gzip_init_fn]("rlsm_gzip_init")

# Feed input bytes and write decompressed output. Returns bytes written or -1.
fn load_rlsm_gzip_feed(ref handle: OwnedDLHandle) -> rlsm_gzip_feed_fn:
    return handle.get_function[rlsm_gzip_feed_fn]("rlsm_gzip_feed")

# Drain the final decompressed bytes from the gzip state.
fn load_rlsm_gzip_finish(ref handle: OwnedDLHandle) -> rlsm_gzip_finish_fn:
    return handle.get_function[rlsm_gzip_finish_fn]("rlsm_gzip_finish")

# Free a GzipState previously returned by rlsm_gzip_init.
fn load_rlsm_gzip_free(ref handle: OwnedDLHandle) -> rlsm_gzip_free_fn:
    return handle.get_function[rlsm_gzip_free_fn]("rlsm_gzip_free")

# Allocate a BrotliState. Returns an opaque pointer; free with rlsm_br_free.
fn load_rlsm_br_init(ref handle: OwnedDLHandle) -> rlsm_br_init_fn:
    return handle.get_function[rlsm_br_init_fn]("rlsm_br_init")

# Feed input bytes and write decompressed output. Returns bytes written or -1.
fn load_rlsm_br_feed(ref handle: OwnedDLHandle) -> rlsm_br_feed_fn:
    return handle.get_function[rlsm_br_feed_fn]("rlsm_br_feed")

# Drain the final decompressed bytes from the brotli state.
fn load_rlsm_br_finish(ref handle: OwnedDLHandle) -> rlsm_br_finish_fn:
    return handle.get_function[rlsm_br_finish_fn]("rlsm_br_finish")

# Free a BrotliState previously returned by rlsm_br_init.
fn load_rlsm_br_free(ref handle: OwnedDLHandle) -> rlsm_br_free_fn:
    return handle.get_function[rlsm_br_free_fn]("rlsm_br_free")
