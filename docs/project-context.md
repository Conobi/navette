...
**Current phase:** idle (M2.5b merged; HC-4 next)
...
- **Test runners:**
  - `bash conformance/scripts/run_tests.sh` (27/27)
  - `bash scripts/run_tests.sh` (33/33 src tests)
...
- **HC-4 — HTTP/2 connection layer:** 🟢 unblocked — M2.5a trait surface is on main; HC-4 spec/plan needs a fresh design pass against the now-concrete trait shapes
