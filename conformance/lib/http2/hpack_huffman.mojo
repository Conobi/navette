# conformance/lib/http2/hpack_huffman.mojo
#
...
struct HuffmanCodec(Movable):
    ...
    def _init_codes(mut self):
        ...
        Codes verified against the Python hpack library
        (hpack.huffman_constants.REQUEST_CODES).
        """
        # Pre-size lists
        for _ in range(257):
        ...
        self.codes[48] = 0x0;     self.code_lengths[48] = 5   # '0'
        self.codes[49] = 0x1;     self.code_lengths[49] = 5   # '1'
        self.codes[50] = 0x2;     self.code_lengths[50] = 5   # '2'
        self.codes[51] = 0x19;    self.code_lengths[51] = 6   # '3'
        self.codes[52] = 0x1A;    self.code_lengths[52] = 6   # '4'
        self.codes[53] = 0x1B;    self.code_lengths[53] = 6   # '5'
        self.codes[54] = 0x1C;    self.code_lengths[54] = 6   # '6'
        self.codes[55] = 0x1D;    self.code_lengths[55] = 6   # '7'
        self.codes[56] = 0x1E;    self.code_lengths[56] = 6   # '8'
        self.codes[57] = 0x1F;    self.code_lengths[57] = 6   # '9'
        ...
        # Symbol 64-95 (uppercase ASCII + some symbols)
        self.codes[64] = 0x1FFA;  self.code_lengths[64] = 13  # '@'
        self.codes[65] = 0x21;    self.code_lengths[65] = 6   # 'A'
        self.codes[66] = 0x5D;    self.code_lengths[66] = 7   # 'B'
        self.codes[67] = 0x5E;    self.code_lengths[67] = 7   # 'C'
        self.codes[68] = 0x5F;    self.code_lengths[68] = 7   # 'D'
        self.codes[69] = 0x60;    self.code_lengths[69] = 7   # 'E'
        self.codes[70] = 0x61;    self.code_lengths[70] = 7   # 'F'
        self.codes[71] = 0x62;    self.code_lengths[71] = 7   # 'G'
        self.codes[72] = 0x63;    self.code_lengths[72] = 7   # 'H'
        self.codes[73] = 0x64;    self.code_lengths[73] = 7   # 'I'
        self.codes[74] = 0x65;    self.code_lengths[74] = 7   # 'J'
        self.codes[75] = 0x66;    self.code_lengths[75] = 7   # 'K'
        self.codes[76] = 0x67;    self.code_lengths[76] = 7   # 'L'
        self.codes[77] = 0x68;    self.code_lengths[77] = 7   # 'M'
        self.codes[78] = 0x69;    self.code_lengths[78] = 7   # 'N'
        self.codes[79] = 0x6A;    self.code_lengths[79] = 7   # 'O'
        self.codes[80] = 0x6B;    self.code_lengths[80] = 7   # 'P'
        self.codes[81] = 0x6C;    self.code_lengths[81] = 7   # 'Q'
        self.codes[82] = 0x6D;    self.code_lengths[82] = 7   # 'R'
        self.codes[83] = 0x6E;    self.code_lengths[83] = 7   # 'S'
        self.codes[84] = 0x6F;    self.code_lengths[84] = 7   # 'T'
        self.codes[85] = 0x70;    self.code_lengths[85] = 7   # 'U'
        self.codes[86] = 0x71;    self.code_lengths[86] = 7   # 'V'
        self.codes[87] = 0x72;    self.code_lengths[87] = 7   # 'W'
        self.codes[88] = 0xFC;    self.code_lengths[88] = 8   # 'X'
        self.codes[89] = 0x73;    self.code_lengths[89] = 7   # 'Y'
        self.codes[90] = 0xFD;    self.code_lengths[90] = 8   # 'Z'
        ...
        self.codes[95] = 0x22;    self.code_lengths[95] = 6   # '_'

        # Symbol 96-127 (lowercase ASCII + some symbols)
        self.codes[96] = 0x7FFD;   self.code_lengths[96] = 15   # '`'
        self.codes[97] = 0x3;      self.code_lengths[97] = 5    # 'a'
        self.codes[98] = 0x23;     self.code_lengths[98] = 6    # 'b'
        self.codes[99] = 0x4;      self.code_lengths[99] = 5    # 'c'
        self.codes[100] = 0x24;    self.code_lengths[100] = 6   # 'd'
        self.codes[101] = 0x5;     self.code_lengths[101] = 5   # 'e'
        self.codes[102] = 0x25;    self.code_lengths[102] = 6   # 'f'
        self.codes[103] = 0x26;    self.code_lengths[103] = 6   # 'g'
        self.codes[104] = 0x27;    self.code_lengths[104] = 6   # 'h'
        self.codes[105] = 0x6;     self.code_lengths[105] = 5   # 'i'
        self.codes[106] = 0x74;    self.code_lengths[106] = 7   # 'j'
        self.codes[107] = 0x75;    self.code_lengths[107] = 7   # 'k'
        self.codes[108] = 0x28;    self.code_lengths[108] = 6   # 'l'
        self.codes[109] = 0x29;    self.code_lengths[109] = 6   # 'm'
        self.codes[110] = 0x2A;    self.code_lengths[110] = 6   # 'n'
        self.codes[111] = 0x7;     self.code_lengths[111] = 5   # 'o'
        self.codes[112] = 0x2B;    self.code_lengths[112] = 6   # 'p'
        self.codes[113] = 0x76;    self.code_lengths[113] = 7   # 'q'
        self.codes[114] = 0x2C;    self.code_lengths[114] = 6   # 'r'
        self.codes[115] = 0x8;     self.code_lengths[115] = 5   # 's'
        self.codes[116] = 0x9;     self.code_lengths[116] = 5   # 't'
        self.codes[117] = 0x2D;    self.code_lengths[117] = 6   # 'u'
        self.codes[118] = 0x77;    self.code_lengths[118] = 7   # 'v'
        self.codes[119] = 0x78;    self.code_lengths[119] = 7   # 'w'
        self.codes[120] = 0x79;    self.code_lengths[120] = 7   # 'x'
        self.codes[121] = 0x7A;    self.code_lengths[121] = 7   # 'y'
        self.codes[122] = 0x7B;    self.code_lengths[122] = 7   # 'z'
        ...
        self.codes[127] = 0xFFFFFFC; self.code_lengths[127] = 28 # DEL
    ...
    def _build_trie(mut self):
        ...
        Root is node 0. Each code is inserted bit-by-bit from MSB to LSB.
        """
        ...
        for sym in range(257):
            ...
            # Walk from MSB to LSB of the code
    ...
    def encode(self, data: List[UInt8]) -> List[UInt8]:
        ...
        Each input byte is replaced by its Huffman code. The output is
        padded with 1-bits to the next byte boundary per RFC 7541 Section 5.2.
        """
        var result = List[UInt8]()
        var current = UInt64(0)  # bit accumulator (64-bit to avoid overflow)
        var bits = 0  # number of valid bits in accumulator
    ...
    def decode(self, data: List[UInt8]) -> Tuple[List[UInt8], String]:
        ...
        Returns (decoded_bytes, error_string). On success error_string
        is empty. On failure decoded_bytes may be partial.

        Errors:
        - "EOS symbol in Huffman data" if the EOS code (symbol 256)
          is encountered in the input stream.
        - "invalid Huffman code" if a bit sequence does not correspond
          to any symbol (walks off the trie).
        - "incomplete Huffman code" if after processing all bits, the
          remaining padding bits exceed 7.
        - "invalid Huffman padding" if the padding bits are not all 1s.
        """
        var result = List[UInt8]()
        ...
        var node_idx = 0  # root
        var bits_since_last_symbol = 0  # bits consumed since last emitted symbol
        var all_ones_since_last_symbol = True  # whether all bits since last symbol are 1
        ...
        # After processing all bits, validate padding.
        # If we are at the root, no padding was needed -- all good.
        if node_idx != 0:
            # There are trailing bits that didn't complete a symbol.
            # Per RFC 7541 Section 5.2:
            #   - Padding must consist of the most-significant bits of
            #     the EOS code (which is all 1s).
